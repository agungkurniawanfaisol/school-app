...
class TestimonialAdminTest extends TestCase
{
    ...
    private const RESOURCE = 'testimonials';
    ...
    private function validPayload(): array
    {
        return [
            ...
            'content' => 'Sekolah yang sangat baik.',
        ];
    }
    ...
    {
        $this->assertAdminStoreValidationFails(self::RESOURCE, [], ['school_id', 'name', 'content']);
    }
    ...
    {
        $id = $this->assertAdminStoreSuccess(self::RESOURCE, $this->validPayload());
        $this->assertAdminUpdate(self::RESOURCE, $id, ['name' => 'Updated Name']);
    }
