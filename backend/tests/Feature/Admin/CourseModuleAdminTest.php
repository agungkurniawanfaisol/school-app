...
class CourseModuleAdminTest extends TestCase
{
    ...
    private const RESOURCE = 'course-modules';
    ...
    {
        $this->assertAdminStoreValidationFails(self::RESOURCE, [], ['course_id', 'title', 'slug']);
    }
    ...
    {
        $id = $this->assertAdminStoreSuccess(self::RESOURCE, $this->validPayload());
        $this->assertAdminUpdate(self::RESOURCE, $id, ['title' => 'Updated Module']);
    }
