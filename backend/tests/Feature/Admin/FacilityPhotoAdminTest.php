...
class FacilityPhotoAdminTest extends TestCase
{
    use AssertsAdminCrud;

    private const RESOURCE = 'facility-photos';

    private function validPayload(): array
    {
        return [
            'facility_id' => Facility::factory()->create()->id,
            'path' => '/storage/facilities/photo.jpg',
        ];
    }
    ...
    {
        $this->assertAdminStoreValidationFails(self::RESOURCE, [], ['facility_id', 'path']);
    }
    ...
    {
        $id = $this->assertAdminStoreSuccess(self::RESOURCE, $this->validPayload());
        $this->assertAdminUpdate(self::RESOURCE, $id, ['caption' => 'Updated Caption']);
    }
