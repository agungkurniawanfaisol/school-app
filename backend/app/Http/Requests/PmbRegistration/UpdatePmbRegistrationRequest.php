...
class UpdatePmbRegistrationRequest extends AdminFormRequest
{
    public function rules(): array
    {
        ...
        return [
            ...
            'registration_number' => ['sometimes', 'string', 'max:50', Rule::unique('pmb_registrations', 'registration_number')->ignore($id)],
