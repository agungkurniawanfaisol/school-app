...
class PortalSubmitPmbRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'draft_payload.jenjang' => ['nullable', 'string', 'in:kb,tk,sd'],
            'draft_payload.program' => ['nullable', 'string', 'max:30'],
            ...
            'payment_info.jenjang' => ['nullable', 'string', 'in:kb,tk,sd'],
            'payment_info.program' => ['nullable', 'string', 'max:30'],
