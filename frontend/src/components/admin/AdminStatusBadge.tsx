...
const STATUS_KEY_MAP: Record<string, string> = {
  ...
  awaiting_verification: 'pages.pmb.statusLabel.awaiting_verification',
  awaiting_payment_review: 'pages.pmb.statusLabel.awaiting_verification',
  submitted: 'pages.pmb.statusLabel.awaiting_verification',
  needs_revision: 'pages.pmb.statusLabel.needs_revision',
  review: 'pages.pmb.statusLabel.needs_revision',
...
const STATUS_VARIANTS: Record<string, 'default' | 'secondary' | 'outline' | 'destructive'> = {
  ...
  awaiting_payment_review: 'outline',
  submitted: 'outline',
